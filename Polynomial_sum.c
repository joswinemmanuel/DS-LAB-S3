...
/*
 ...
 Enter the COEFFICIENT and EXPONENT in DESCENDING ORDER
   ...
   Enter the Coefficient(3): 1
      Enter the exponent(3): 0
 
 First polynomial : 3(x^2)+2(x^1)+1(x^0)
 ...
 Second polynomial : 4(x^4)+3(x^1)+1(x^0) 

 Resultant polynomial after addition : 4(x^4)+3(x^2)+5(x^1)+2(x^0)
 */